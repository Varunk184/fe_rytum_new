...
export default function Footer() {
 ...
 <div className="w-full md:w-1/4 mb-10 md:mb-0 flex flex-col items-center md:items-center justify-between text-center">
            <h2 className="text-gray-900 font-medium tracking-wider text-lg text-center lg:ml-auto">
              Incubated with
            </h2>
            <div className="flex flex-col md:flex-row items-center -mt-3 md:space-y-0 md:space-x-4">
              <Image
                src="/assets/google.png" // Replace with the correct image path
                alt="Google Logo"
                width={125}
                height={75}
                priority
                className="w-auto mr-2 lg:ml-8 h-20"
              />
              <Image
                src="/assets/microsoft.png" // Replace with the correct image path
                alt="microsoft Logo"
                width={125}
                height={75}
                priority
                className="w-auto -mt-6 sm:-ml-2 h-32"
              />
            </div>
          </div>
          {/* Right side sections */}
